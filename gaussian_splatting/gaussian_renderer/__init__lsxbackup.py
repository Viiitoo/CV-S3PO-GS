...
def render(
    ...
    if mask is not None:
        ...
        print(" xyz:", pc.get_xyz.shape)
        print(" scaling:", pc._scaling.shape)
        print(" rot:", pc._rotation.shape)
        print(" opacity:", pc._opacity.shape)
        print(" covariance:", pc.get_covariance().shape)
